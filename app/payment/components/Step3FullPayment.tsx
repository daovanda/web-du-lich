      ...
      >
        ...
        <div className="flex justify-center mb-6">
          <img
            ...
            alt="QR Code"
            className="w-64 h-64 border-4 border-red-400/30 rounded-xl"
          />
        </div>
        ...
        <div className="space-y-3 bg-black/30 rounded-xl p-4">
          ...
          <div className="flex justify-between items-center">
            <span className="text-gray-400 text-sm">Số tiền còn lại:</span>
          ...
          <div className="border-t border-white/10 pt-3 mt-3">
            ...
            <button
              ...
              className="w-full bg-red-500/20 border-2 border-red-500/30 rounded-lg p-3 font-mono font-bold text-red-300 hover:bg-red-500/30 transition flex items-center justify-between"
            >
              {transferContent}
        ...
        <div className="mt-4 bg-red-500/20 border border-red-500/30 rounded-lg p-3 flex items-start gap-2">
