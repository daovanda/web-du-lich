...
export default function Step4WaitingPaymentConfirm({
  ...
  return (
    ...
    >
      {/* Header Section */}
      <div className="p-8 text-center bg-gradient-to-b from-orange-500/5 to-transparent border-b border-neutral-800">
        {/* Animated Clock Icon */}
        <div className="relative inline-flex items-center justify-center mb-6">
          <div className="absolute w-24 h-24 rounded-full bg-orange-500/20 animate-ping" />
          <div className="relative w-20 h-20 rounded-full bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center shadow-[0_0_40px_rgba(249,115,22,0.4)]">
        ...
        <p className="text-neutral-400 text-sm max-w-md mx-auto leading-relaxed">
          Chúng tôi đã nhận được chứng minh thanh toán phần còn lại và đang xử lý
        </p>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-xl p-5">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-base font-semibold text-white mb-3">Thông tin thanh toán</h3>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-neutral-500">Tổng đơn hàng</span>
                  <span className="text-sm font-semibold text-white">
                    {formatCurrency(booking.total_price)}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-neutral-500">Đã đặt cọc</span>
        ...
        <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-5">
          <h3 className="text-sm font-semibold text-white mb-4">Tiến trình xác nhận</h3>
          <div className="space-y-3">
            {[
              { icon: "✅", title: "Đã nhận chứng minh thanh toán", status: "Hoàn thành", color: "text-green-400" },
              { icon: "🔍", title: "Đang kiểm tra số tiền", status: "Đang xử lý", color: "text-orange-400" },
              { icon: "⏳", title: "Chờ xác nhận cuối cùng", status: "Đang chờ", color: "text-neutral-500" }
            ].map((step, index) => (
        ...
        <div className="flex items-start gap-3 p-4 bg-neutral-900/50 border border-neutral-800 rounded-xl">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2">
              <a
                href="tel:0912345678"
                className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 rounded-lg text-sm font-semibold text-white transition-all duration-200 active:scale-95"
              >
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-1.5 text-xs text-green-200">
                <li className="flex items-start gap-2">
                  ...
                  <span>Bạn sẽ nhận được email/SMS xác nhận khi hoàn tất</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>Sau khi xác nhận, bạn có thể sử dụng dịch vụ ngay</span>
                </li>
              </ul>
            </div>
          </div>
